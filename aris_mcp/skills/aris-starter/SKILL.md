...
name: aris-starter
description: >-
  Aris API + MCP Server + A2A Server Use when working with Aris via this package's MCP
...
Starter skill for the **Aris** package. Use the `mcp-client` universal skill
